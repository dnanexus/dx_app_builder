...
dx run app_scatter -iexec_id=applet-F9Y45g00pjvVJJP88gKpYkGg -ibatch_inputs='{"a": [{"$dnanexus_link": "file-F9Y4xq80pjvvJvjB8g6YQppQ"}]}' -ifiles="file-F9Y4xq80pjvvJvjB8g6YQppQ" -iinstance_types="mem1_ssd1_x4" -y --watch
